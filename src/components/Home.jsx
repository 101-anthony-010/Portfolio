...
const Home = () => {
  ...
  return (
    <main id='home' className='flex flex-wrap m-6 mt-16 justify-center gap-8'>
      <section className='max-w-md'>
        ...
        <button className='py-3 px-10 bg-blue-500 text-white rounded-md m-4 font-semibold'>About me <i className='bx bx-chevron-right-circle'></i></button>
      </section>
      <div className='w-[300px] h-[400px] hover:w-[310px] hover:h-[410px] transition-all duration-500'>
        <img className='w-full h-full object-cover rounded-xl' src="/public/images/antony.png" alt="" />
      </div>
    </main>
  )
}
