...
const Menu = () => {
  ...
  return (
    <main className={`grid justify-end items-start fixed ${isShowMenu ? "right-0":"-right-[100%]"} transition-all duration-700 w-full top-0 h-screen right-0 z-20`}>
        <div onClick={handleClickChangeClose} className={`${isShowMenu ? "right-0" : "-right-[100%]"} transition-all duration-500 fixed top-0 right-0 w-full h-full bg-gray-500/20`}></div>
